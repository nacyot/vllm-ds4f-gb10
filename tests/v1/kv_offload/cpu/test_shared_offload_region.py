...
def test_create_next_worker_view_cursor_advances(iid):
    """Each call to create_next_worker_view must advance _worker_offset by tensor_page_size."""
...
def test_create_next_worker_view_write_visible_in_raw_mmap(iid):
    """Writes into a create_next_worker_view view must appear at the correct raw mmap offset"""
