...
class DefaultModelLoader(BaseModelLoader):
    ...
    def _prepare_weights(
        ...
        # A list of exact filenames (no glob metacharacters) is a union, e.g.
        # a folded draft model restricting the scan to the shards holding its
        # tensors. Glob patterns keep the first-match fallback ladder.
        ...
        if use_safetensors:
            ...
            if exact_overrides:
                # The caller picked exact shard names out of the index; the
                # index-vs-files completeness check would reject the subset.
