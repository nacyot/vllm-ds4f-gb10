...
class DeepseekV4Indexer(nn.Module):
    ...
    def forward(
        ...
        if isinstance(attn_metadata, dict):
            ...
            # vLLM PR #52492 (2026-08-17): never take the "all candidates
            # selected" shortcut inside a CUDA-graph capture. A captured
            # shortcut replayed on a long cached prefix skips indexer scoring
            # and selects candidates 0..topk unscored (garbage attention,
            # reasoning loops; upstream #52448, mia #115).
            if (
