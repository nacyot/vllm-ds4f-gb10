...
KNOBS=""; for k in GMU KVMEM MAXLEN SEQS MNBT EAGER CAPTURE_SIZES CAPTURE_SIZES_EXPLICIT CUDAGRAPH_MODE SPEC SPEC_K SPEC_DRAFT SPEC_EXTRA TEXT_ONLY THINKING ENGRAM_MMAP ENGRAM_THREADS ENGRAM_STATS EXTRA_ARGS PORT; do
