...
KNOBS=""; for k in GMU KVMEM MAXLEN SEQS MNBT EAGER CAPTURE_SIZES CUDAGRAPH_MODE SPEC SPEC_K TEXT_ONLY THINKING ENGRAM_MMAP ENGRAM_THREADS ENGRAM_STATS EXTRA_ARGS PORT; do
